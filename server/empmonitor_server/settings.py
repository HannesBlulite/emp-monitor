"""
Django settings for empmonitor_server project.
"""
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-&9k&@j32g(m=q^7j#zejjpbgx+d2u*p3q()j(^r+2@ikdc92co'
)
...
ROOT_URLCONF = 'empmonitor_server.urls'
...
WSGI_APPLICATION = 'empmonitor_server.wsgi.application'
...
# Production security and retention settings
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@ddcemp.co.za')
